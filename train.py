...
if __name__ == "__main__":
    ...
    tb_logger = TensorBoardLogger(hparams.output_path, log_graph=True, name='tb')
    wandb_logger = WandbLogger(save_dir = hparams.output_path,name = hparams.name, project="IUNet_2")
